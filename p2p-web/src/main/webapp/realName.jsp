        ...
        <div class="fl">
            ...
            <div class="login-form reg-form">
              ...
              <div class="login-box clearfix " style="z-index:90;">
                ...
                <!--再次确认身份证号码
                    checkIdCardAgain()  再次确认身份证号码
                -->
              <%--<div class="login-box clearfix" style="z-index:80;">--%>
                <%--<!--显示错误提示层的外框架加行内样式  z-index:11;-->--%>
                <%--<label>确认身份证号</label>--%>
                <%--<input type="text" id="replayIdCard" name="replayIdCard" class="input_text" maxlength="21"  placeholder="请再次输入15位或20位身份证号码" onblur="checkIdCardAgain();"/>--%>
