        ...
        <div class="credenMain clearfix">
            ...
            <div class="credenBasic">
                ...
                <ul class="credenBalance">
                    <li class="availMoney">
                        <h3>可用余额：</h3>
                        <%--${financeAccount.availableMoney}
                             注意这个一个是 formatNumber 更改字数字的样式
                        --%>
                        <span class="moneyIcon"><i> <fmt:formatNumber value="${financeAccount.availableMoney}"
                                                                      type="currency"/> 元</i></span>
            ...
            <div class="eachInvest invest-tab">
                ...
                <div class="invest-tab-box">
                    <dl>
                        ...
                        --%>
                        <c:forEach varStatus="bidInfoStatus" var="bidInfo" items="${bidInfoList}">
                            <dd>
                                <span class="name">${bidInfoStatus.count}</span>
                                <span id="preparedLoanTotalLoanCount"
                                      class="number">${bidInfo.loanInfo.productName}</span>
                                <span id="preparedLoanTotalBidMoney" class="money">${bidInfo.bidMoney}</span>
                                <span id="preparedLoanTotalIncome" class="profit"><fmt:formatDate
                                        value="${bidInfo.bidTime}" pattern="yyyy-MM-dd HH:mm:ss"/> </span>
                            </dd>
