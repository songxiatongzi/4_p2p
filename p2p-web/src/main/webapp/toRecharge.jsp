...
<head>
    ...
    <script type="text/javascript">
        ...
        //提交表单前验证表单数据(当提交表单的时候，将隐藏域中的值取出)
        function submitForm() {
            ...
            if (checkData()) {
                ...
                if(payType == "weixinpay"){
                    //在微信提交之前将值存放到隐藏域中(提交的金额)
                    $("#weixinpayRechargeMoney").val(rechargeMoney);
                    //微信支付
                    $("#weixinpayRechargeForm").submit();
                }
            }
        }
    </script>
                        ...
                        <div class="investMain">
                            ...
                            <div class="investContent">
                                <div class="investOver clearfix" id="banks2">
                                        ...
                                        <%--支付宝
                                            alipayRechargeMoney = 用户提交的金额
                                        --%>
                                    <form id="alipayRechargeForm"
                                          action="${pageContext.request.contextPath}/loan/toAlipayRecharge" method="post" target="_blank">
                                        <input type="hidden" name="rechargeMoney" id="alipayRechargeMoney"/>
                                    </form>
                                    <label>
                                        <%--对支付宝[图片]绑定了事件--%>
                                        ...
                                        <%--微信支付
                                            weixinpayRechargeMoney = 用户提交的金额
                                        --%>
                                    <form id="weixinpayRechargeForm"
                                          action="${pageContext.request.contextPath}/loan/toWxPayRecharge" method="post" target="_blank">
                                        <input type="hidden" name="rechargeMoney" id="weixinpayRechargeMoney"/>
